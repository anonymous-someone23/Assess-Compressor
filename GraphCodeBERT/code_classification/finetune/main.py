            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.save_steps > 0 and global_step % args.save_steps == 0:
                    ...
                    if results["eval_acc"] >= best_acc:
                        ...
                        output_dir = os.path.join(args.output_dir, "{}".format(checkpoint_prefix), args.dataset)
...
def evaluate(args, model, tokenizer, eval_when_training=False):
    ...
    if "unlabel_train" in args.eval_data_file:
        tem_path = "../../../data/code_classification/{}/preds_unlabel_train_gcb".format(args.dataset)
        np.save(tem_path, logits)
...
def main():
    ...
    if args.do_eval:
        ...
        # exit()
        checkpoint_prefix = "checkpoint"
        output_dir = os.path.join(args.output_dir, "{}".format(checkpoint_prefix), args.dataset, 'model.bin')
